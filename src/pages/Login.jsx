...
const Login = () => {
    ...
    const handleGoogleLogin = async (credentialResponse) => {
        try {
            setIsLoading(true);
            const res = await axios.post(BASE_URL + "/auth/google/callback", {
            ...
            const msg = error?.response?.data?.message || error?.response?.data || "Google login failed. Please try again.";
            const errorMsg = typeof msg === "string" ? msg : "Google login failed. Please try again.";
            setApiError(errorMsg);
            toast.error(errorMsg);
        } finally {
            setIsLoading(false);
            ...
            <div className="login-card">
                ...
                <div className="login-social-row">
                    <button className="login-social-btn"
                        onClick={() => {
                            window.location.href = "https://devsyncapp.in/api/auth/github";
                        }}
                    >
