...
const chatIcon = (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12.75A6.75 6.75 0 0 1 9 6h6a6.75 6.75 0 0 1 6.75 6.75v.75A6.75 6.75 0 0 1 15 21H9a7.43 7.43 0 0 1-2.813-.548L2.25 21l1.035-3.45A6.73 6.73 0 0 1 2.25 14.25v-1.5Z" />
    </svg>
);
